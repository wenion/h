...
class UserRole(EmbeddedJsonModel):
    ...
    joined_year: Optional[NonNegativeInt] = Field(index=True)
    years_of_experience: Optional[NonNegativeInt] = Field(index=True)
    expert: Optional[NonNegativeInt] = Field(index=True)
